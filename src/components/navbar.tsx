...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center h-24 justify-between max-w-[1280px] px-6 mx-auto z-100">
      ...
      <div
        className={
          nav
            ? "fixed left-0 top-4 h-full p-4 w-[60%] border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500"
            : "fixed left-[-100%]"
        }
      >
        <h1 className="text-3xl font-bold text-[#00DF9a]">HeeTech.</h1>
